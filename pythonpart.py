...
actions_mnch = ["придумали","сделали","изобрели","подписали","поставили на пост презедента","отправили на луну","посадили в тюрьму"]
actions_credniy = ["придумало","сделало","изобрело","подписало","поставило на пост презедента","отправило на луну","посадило в тюрьму"]
actions_woman = ["придумала","сделала","изобрела","подписала","поставила на пост презедента","отправила на луну","посадила в тюрьму"]
actions_man = ["придумал","сделал","изобрел","подписал","поставил на пост презедента","отправил на луну","посадил в тюрьму"]
